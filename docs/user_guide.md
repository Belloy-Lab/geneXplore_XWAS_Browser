...
- **Note:** Gene labels are only shown for top variants with P < 1×10<sup>-6</sup>, to reduce the number of visualized genes and focus on the most significant associations
