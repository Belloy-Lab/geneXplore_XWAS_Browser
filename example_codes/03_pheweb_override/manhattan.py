...
# =============================================================================
# geneXplore modification: BIN_LENGTH reduced from default (3e6) to 3e4
# This corrects Manhattan plot binning for single-chromosome (X-only) data.
# The default bin size is designed for genome-wide data and produces
# incorrectly coarse bins when applied to a single chromosome.
# =============================================================================
BIN_LENGTH = int(3e4)
